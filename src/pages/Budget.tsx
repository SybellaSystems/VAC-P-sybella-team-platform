...
export function Budget({ user }: { user?: { id?: string; role?: string } }) {
...
setStepsByProposal(((_prev: any) => {
      const safePrev: Record<string, ApprovalStep[]> = (_prev ?? {}) as Record<string, ApprovalStep[]>;
      return { ...safePrev, [selectedId]: (data ?? []) as ApprovalStep[] };
    }) as any);
    };
    loadSteps();
  }, [supabase, selectedId]);
    ...
    <div className="bg-[#050505] min-h-screen pt-28 pb-20 px-6">
      ...
      <div className="mx-auto max-w-7xl">
        <header className="mb-10">
          <h1 className="text-[10px] font-black text-blue-500 uppercase tracking-[0.4em] mb-6">Budget Proposals & Approval Workflows</h1>
